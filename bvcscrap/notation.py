def notation():
    return ['Addoha', 'AFMA', 'Afric Indus', 'Afriquia Gaz', 'Agma', 'Akdital', 'Alliances',
            'Aluminium Maroc', 'Aradei Capital', 'ATLANTASANAD', 'Attijariwafa', 'Auto Hall',
            'Auto Nejma', 'BALIMA', 'BOA', 'BCP', 'BMCI', 'Cartier Saada', 'CDM', 'CIH',
            'Ciments Maroc', 'CMT', 'Colorado', 'COSUMAR', 'CTM', 'Dari Couspate',
            'Delta Holding', 'Disty Technolog', 'DISWAY', 'Ennakl', 'EQDOM', 'FENIE BROSSETTE',
            'HPS', 'IBMaroc', 'Immr Invest', 'INVOLYS', 'Jet Contractors', 'LABEL VIE',
            'LafargeHolcim', 'Lesieur Cristal', 'M2M Group', 'Maghreb Oxygene', 'Maghrebail',
            'Managem', 'Maroc Leasing', 'Maroc Telecom', 'Microdata', 'Mutandis', 'Oulmes',
            'PROMOPHARM', 'Rebab Company', 'Res.Dar Saada', 'Risma', 'S2M', 'Sanlam Maroc',
            'SALAFIN', 'SMI', 'Stokvis Nord Afr', 'SNEP', 'SODEP', 'Sonasid', 'SOTHEMA',
            'SRM', 'Ste Boissons', 'STROC Indus', 'TAQA Morocco', 'TGCC', 'Timar',
            'Total Maroc', 'Unimer', 'Wafa Assur', 'Zellidja', 'MASI', 'MSI20']
...
def notation_value():
    return {
        ...
        'Agma': '6700', 'Alliances': '11200', 'Aluminium Maroc': '6600', 'Aradei Capital': '27',
        'ATLANTASANAD': '10300', 'Attijariwafa': '8200', 'Auto Hall': '3200', 'Auto Nejma': '7000',
        'BALIMA': '3300', 'BOA': '1100', 'BCP': '8000', 'BMCI': '5100', 'Cartier Saada': '8900',
        'CDM': '3600', 'CIH': '3100', 'Ciments Maroc': '4000', 'CMT': '11000', 'Colorado': '9200',
        'COSUMAR': '4100', 'CTM': '2200', 'Dari Couspate': '8500', 'Delattre Lev': '10800',
        'Delta Holding': '10900', 'DISWAY': '9700', 'Ennakl': '11300', 'EQDOM': '2300',
        'FENIE BROSSETTE': '9300', 'HPS': '9600', 'IBMaroc': '7600', 'Immr Invest': '12',
        'INVOLYS': '9500', 'Jet Contractors': '11600', 'LABEL VIE': '11100',
        'LafargeHolcim': '3800', 'Lesieur Cristal': '4800', 'M2M Group': '10000',
        'Maghreb Oxygene': '7200', 'Maghrebail': '1600', 'Managem': '7300',
        'Maroc Leasing': '2500', 'Maroc Telecom': '8001', 'Med Paper': '6500',
        'Microdata': '10600', 'Mutandis': '21', 'Nexans Maroc': '7400', 'Oulmes': '5200',
        'PROMOPHARM': '9900', 'Rebab Company': '5300', 'Res.Dar Saada': '12000', 'Risma': '8700',
        'S2M': '11800', 'Sanlam Assurance': '11400', 'SALAFIN': '10700', 'SMI': '1500',
        'Stokvis Nord Afr': '10500', 'SNEP': '9400', 'SODEP': '12300', 'Sonasid': '1300',
        'SOTHEMA': '9800', 'SRM': '2000', 'Ste Boissons': '10400', 'STROC Indus': '11500',
        'TAQA Morocco': '11900', 'Timar': '10100', 'Total Maroc': '12100', 'Unimer': '7500',
        'Wafa Assur': '6400', 'Zellidja': '5800', 'Akdital': '35',
        'Disty Technolog': '32', 'TGCC': '29',
    }
